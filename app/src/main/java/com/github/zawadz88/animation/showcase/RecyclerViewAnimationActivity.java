 ...
 * #####
 * #####
 * Source: https://github.com/google/android-ui-toolkit-demos/tree/master/RecyclerView/RecyclerViewAnimations
 * See for explanation: http://frogermcs.github.io/recyclerview-animations-androiddevsummit-write-up/
 * #####
 * #####
 */
public class RecyclerViewAnimationActivity extends AbstractActivity {
    ...
    @BindView(R.id.predictiveCB)
    CheckBox mPredictiveCB;

    @BindView(R.id.customCB)
    CheckBox mCustomCB;
